...
@interface VESTSendCell ()
@property (nonatomic,strong) UIImageView *headImageview;
@property (nonatomic,strong) UIView *bgView;
@property (nonatomic,strong) UILabel *titleLable;
@end

@implementation VESTSendCell
...
- (void)baseConstraintsConfig
{
    ...
    [self.bgView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.headImageview.mas_left).offset(-9);
...
- (void)setMessage:(VESTMessageModel *)message
{
    ...
    self.headImageview.image = [VESTUserTool GetHeadImageFromLocal];
}
@end
