...
@implementation XXLockIndicator
...
- (void)showPasscode:(NSString *)passcode
{
    ...
    for (int i = 0; i < passcode.length; i++)
    {
        ...
        [self.circleArray[number.intValue] updateCircleState:XXLockCircleStateFill];
