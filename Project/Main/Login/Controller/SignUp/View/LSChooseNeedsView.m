...
#import "LSChooseNeedsView.h"
#import "LSSignUpChooseCell.h"

@interface LSChooseNeedsView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@end
@implementation LSChooseNeedsView
...
{
    return CGSizeMake(XW(142), XW(200));
}
//定义每个Section的四边间距
-(UIEdgeInsets)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout insetForSectionAtIndex:(NSInteger)section
{
    return UIEdgeInsetsMake(15, XW(40), 15, XW(40));
}
...
{
    if(!_dataArray){
        _dataArray = @[@"Party",@"Sport",@"Traveling",@"Chat"];
    }
    return _dataArray;
}
