...
#import "LSChooseAgeView.h"
#import "LSSignUpChooseCell.h"

@interface LSChooseAgeView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation LSChooseAgeView
...
{
    return CGSizeMake(XW(300), XW(200));
}
//定义每个Section的四边间距
